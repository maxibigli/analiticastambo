...
def sql_produccion_por_lactancia(desde, hasta, herd=None) -> str:
    ...
    return f"""
        ...
        JOIN CMSGroupMilkSetting c ON c.[Group] = ad.AnimalGroup
                                    AND c.GCRecord IS NULL AND c.EnableMilking = 1
